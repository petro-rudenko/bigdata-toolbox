...
Vagrant VM with preinstalled [HDP Stack](http://hortonworks.com/products/hdp/hdp2/) and additional big data software/libs.

## What's inside:
1. Hadoop [HDP stack](http://hortonworks.com/products/hdp/hdp2/):
